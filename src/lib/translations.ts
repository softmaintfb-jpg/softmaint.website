...
const itTranslations = {
  ...
  hero: {
    ...
    subtitle2: 'ERP | Tesoreria | WebApp: Produzione, Logistica, Agenti, Mail, Tentata Vendita e Connettori B2B.',
    btnServizi: 'Soluzioni Software',
    btnWebTicket: 'WebTicket',
  ...
  servizi: {
    ...
    ctaTitle: 'Richiesta WebTicket',
    ctaText: 'Modulo per l\'invio di richieste di assistenza tecnica.',
    ctaBtn: 'Effettua una richiesta',
    richiediInfo: 'Richiedi info',
    docfinanceCta: 'Scopri di più',
    erpCta: 'Scopri di più sull\'ERP',
    scopriWeb: 'Scopri le soluzioni web',
    supremoTitle: 'Richiesta Ordine di Servizio',
    supremoDescription: 'Modulo per l\'invio di richieste di intervento tecnico o aggiornamenti software.',
    supremoBtn: 'Effettua un ordine',
  },
  // Servizi dettagli
  serviziDetails: {
    docfinance: {
  ...
  erpPage: {
    ...
    modules: [
      { title: 'Contabilità' },
      { title: 'Cespiti Ammortizzabili' },
      { title: 'Liquidazione Telematica IVA' },
      { title: 'Corrispettivi' },
      { title: 'Acquisizione Automatica Dati Anagrafici' },
      { title: 'Contabilità Analitica' },
      { title: 'Flussi Finanziari' },
      { title: 'Crisi D\'Impresa' },
      { title: 'Riconciliazione Bancaria' },
      { title: 'Documenti' },
      { title: 'Shop Connector' },
      { title: 'Ordini e DDT Elettronici' },
      { title: 'Passport e Peppol' },
      { title: 'Vendite al banco' },
      { title: 'Fatturazione Elettronica PA e Privati (EX FEPA)' },
      { title: 'Fatturazione Elettronica Passiva' },
      { title: 'Importer di Files' },
      { title: 'Gestione Estesa Accessi' },
      { title: 'DMS' },
      { title: 'Magazzino' },
      { title: 'Programmazione Acquisti' },
      { title: 'Programmazione Acquisti Per Commesse' },
      { title: 'Evasione con Controllo Giacenza' },
      { title: 'Gestione Documenti USER WEB' },
      { title: 'Gestione Processi USER WEB' },
      { title: 'Data Analyzer' },
      { title: 'Web Analyzer' },
      { title: 'BUDGET COMMERCIALE' },
      { title: 'OPERAZIONI PIANIFICATE' },
      { title: 'DISTINTA BASE' },
      { title: 'PIANIFICAZIONE DEI MATERIALI (MRP) /ANALISI DEI FABBISOGNI' },
      { title: 'PIANIFICAZIONE DEI MATERIALI PER COMMESSA (MRP PER COMMESSA)' },
      { title: 'ASSEMBLY TO ORDER (ATO)' },
      { title: '4CONNECTION' },
      { title: 'GESTIONE DELLA PRODUZIONE AVANZATA' },
      { title: 'RILEVA' },
      { title: 'EASYPLANNING' },
      { title: 'GESTIONE AVANZATA COMMESSE' },
      { title: 'GESTIONE ASSISTENZA' },
      { title: 'GESTIONE CONTRATTI' },
      { title: 'GESTIONE NOLEGGI' },
    ],
  ...
  contatti: {
    ...
    redirect: 'Per assistenza Gestionale ERP e WebApp, visita',
  ...
  footer: {
    ...
    soluzioni: 'Soluzioni',
    contattiTitle: 'Contatti & Sede',
    telefono: '+39 081 8232059',
    email: 'info@softmaint.it',
    indirizzo: 'Via On. F.sco Napolitano, 185 – 80035 Nola (NA)',
  ...
  productPageUI: {
    ...
    videoLabel: 'Video dimostrativo',
    videoDesc: 'Guarda una breve presentazione del prodotto in azione.',
  ...
  docfinancePage: {
    tornaServizi: 'Torna ai servizi',
    heroBadge: 'Piattaforma di Tesoreria',
    heroTitle: 'DocFinance',
    heroSubtitle: 'La soluzione completa per gestire incassi, pagamenti e tesoreria con automazioni intelligenti e visibilita totale.',
    requestDemo: 'Richiedi una demo',
    learnMore: 'Scopri di piu',
    statsERP: 'Integrazioni ERP',
    statsBanks: 'Banche supportate',
    statsCompanies: 'Aziende coperte',
    whatTitle: 'Cos\'e DocFinance?',
    whatSubtitle: 'Una piattaforma innovativa pensata per i CFO e i tesorieri che vogliono ridurre complessita operativa e aumentare il controllo sulle finanze aziendali.',
    feature1Title: 'Automazione incassi e pagamenti',
    feature1Desc: 'Gestione centralizzata con visibilita aggiornata in tempo reale.',
    feature2Title: 'Riconciliazione bancaria',
    feature2Desc: 'Tracciamento accurato e riduzione degli errori operativi.',
    feature3Title: 'Multi-azienda',
    feature3Desc: 'Supporto completo per strutture singole o di gruppo.',
    capabilitiesTitle: 'Funzionalita principali',
    planning: 'Pianificazione finanziaria',
    planningDesc: 'Tesoreria integrata con banche ed ERP, adatta a qualsiasi dimensione aziendale.',
    credit: 'Gestione del credito',
    creditDesc: 'Valutazione controparti e recupero credito con reportistica completa.',
    ctaTitle: 'Pronto a trasformare la tua finanza aziendale?',
    ctaSubtitle: 'Scopri come DocFinance puo aiutare la tua organizzazione a semplificare processi, ridurre errori e prendere decisioni piu veloci.',
    visitDocFinance: 'Visita DocFinance',
  },
  ...
  productDetail: {
    ...
    smartProduzione: {
      ...
      highlights: [
        ...
        'Applicativo utilizzato per la produzione di Plastica, Nocciole, Caffe, Banda Stagnata e molto altro',
  ...
  webticketPage: {
    badge: 'Softmaint SRL | WebTicket',
    title: 'Richiesta di Assistenza Tecnica',
    subtitle: 'Compila il modulo sottostante per aprire un ticket di assistenza.',
    successTitle: 'WebTicket Inviato con Successo!',
    successDesc: 'Il tuo ticket è stato preso in carico. Uno dei nostri tecnici ti ricontatterà al più presto.',
    btnAnother: 'Invia un altro ticket',
    sectionRequester: 'Dati del Richiedente',
    labelNome: 'Nome',
    labelCognome: 'Cognome',
    labelRagioneSociale: 'Ragione Sociale',
    ...
    labelTelefonoFisso: 'Telefono fisso',
    labelCellulare: 'Cellulare',
    sectionTicket: 'Dettagli del WebTicket',
    ...
    btnPreview: 'Anteprima Email',
    previewTitle: 'Anteprima Email WebTicket',
    previewSubject: 'Oggetto',
    previewFrom: 'Da',
    previewTo: 'A',
    previewReplyTo: 'Rispondi a',
    previewAttachments: 'Allegati',
    previewNoAttachments: 'Nessun file allegato',
    previewNoDesc: 'Nessuna descrizione inserita.',
    previewClose: 'Chiudi',
    erpOptions: {
      option1: 'ERP - Contabilità',
      option2: 'ERP - Documenti',
      option3: 'ERP - Magazzino',
      option4: 'ERP - Produzione',
...
const enTranslations: typeof itTranslations = {
  ...
  hero: {
    ...
    subtitle2: 'ERP | Treasury | WebApp: Production, Logistics, Agents, Mobile, Door to Door Sales and B2B Connectors.',
  ...
  servizi: {
    ...
    ctaTitle: 'WebTicket Request',
    ctaText: 'Module for submitting technical assistance requests.',
    ...
    supremoTitle: 'Service Order Request',
    supremoDescription: 'Form for submitting requests for technical intervention or software updates.',
    supremoBtn: 'Submit an order',
  },
  // Servizi dettagli
  serviziDetails: {
    docfinance: {
  ...
  erpPage: {
    ...
    modules: [
      { title: 'Accounting' },
      { title: 'Fixed Assets' },
      { title: 'Automatic VAT Settlement' },
      { title: 'Receipts Management' },
      { title: 'Automatic Data Acquisition' },
      { title: 'Cost Accounting' },
      { title: 'Cash Flows' },
      { title: 'Business Crisis Management' },
      { title: 'Bank Reconciliation' },
      { title: 'Documents' },
      { title: 'Shop Connector' },
      { title: 'Electronic Orders and DDT' },
      { title: 'Passport and Peppol' },
      { title: 'Counter Sales' },
      { title: 'Electronic Invoicing PA and Private (EX FEPA)' },
      { title: 'Passive Electronic Invoicing' },
      { title: 'File Importer' },
      { title: 'Extended Access Management' },
      { title: 'DMS' },
      { title: 'Warehouse' },
      { title: 'Purchase Planning' },
      { title: 'Purchase Planning by Project' },
      { title: 'Fulfillment with Stock Control' },
      { title: 'USER WEB Document Management' },
      { title: 'USER WEB Process Management' },
      { title: 'Data Analyzer' },
      { title: 'Web Analyzer' },
      { title: 'Commercial Budget' },
      { title: 'Scheduled Operations' },
      { title: 'Bill of Materials' },
      { title: 'Material Planning (MRP) / Demand Analysis' },
      { title: 'Material Planning by Project (MRP by Project)' },
      { title: 'Assembly to Order (ATO)' },
      { title: '4Connection' },
    ...
    bodyLead: 'This ERP is built for structured enterprises and evolved SMEs that need to handle complexity without slowing down daily operations.',
    p1: 'As order volumes, customers, and sales channels increase, the need for better coordination across data, activities, and responsibilities grows. Operating with separate tools or manual procedures often leads to delays, redundancies, and less effective decisions.',
    p2: 'With a centralized platform you can digitize core workflows, connect accounting, purchasing, warehouse, production, and sales teams, and keep information always consistent, updated, and available in real time.',
    p3: 'The goal is not just automation: it means making processes more reliable, reducing operational errors, improving service quality toward customers and suppliers, and building a solid data foundation for planning and control.',
    p4: 'The solution is modular and can be configured around your organizational priorities, supporting growth over time without imposing a rigid operating model.',
  },
  // Chi Siamo
  chiSiamo: {
    label: 'Our story',
  ...
  contatti: {
    ...
    redirect: 'For assistance with ERP Software and WebApp, visit ',
  ...
  footer: {
    ...
    soluzioni: 'Solutions',
    contattiTitle: 'Contacts & Location',
    telefono: '+39 081 8232059',
    email: 'info@softmaint.it',
    indirizzo: 'Via On. F.sco Napolitano, 185 – 80035 Nola (NA), Italy',
    orari: 'Mon – Fri: 9:00 – 13:00 | 14:00 – 18:00',
  ...
  productPageUI: {
    ...
    videoDesc: 'Watch a short presentation of the product in action.',
  ...
  docfinancePage: {
    tornaServizi: 'Back to Services',
    heroBadge: 'Treasury Platform',
    heroTitle: 'DocFinance',
    heroSubtitle: 'The complete solution to manage collections, payments and treasury with intelligent automations and total visibility.',
    requestDemo: 'Request a Demo',
    learnMore: 'Learn More',
    statsERP: 'ERP Integrations',
    statsBanks: 'Supported Banks',
    statsCompanies: 'Companies Covered',
    whatTitle: 'What is DocFinance?',
    whatSubtitle: 'An innovative platform designed for CFOs and treasurers who want to reduce operational complexity and increase control over corporate finances.',
    feature1Title: 'Collections and Payments Automation',
    feature1Desc: 'Centralized management with real-time visibility updates.',
    feature2Title: 'Bank Reconciliation',
    feature2Desc: 'Accurate tracking and reduction of operational errors.',
    feature3Title: 'Multi-company',
    feature3Desc: 'Complete support for single or group structures.',
    capabilitiesTitle: 'Key Features',
    planning: 'Financial Planning',
    planningDesc: 'Treasury integrated with banks and ERP, suitable for any company size.',
    credit: 'Credit Management',
    creditDesc: 'Counterparty assessment and credit recovery with complete reporting.',
    ctaTitle: 'Ready to Transform Your Corporate Finance?',
    ctaSubtitle: 'Discover how DocFinance can help your organization simplify processes, reduce errors, and make faster decisions.',
    visitDocFinance: 'Visit DocFinance',
  },
  // Product Detail Pages (quote request screens)
  productDetail: {
    smartLogistica: {
    ...
    smartProduzione: {
      ...
      highlights: [
        ...
        'Application used for the production of Plastic, Hazelnut, Coffee, Tinplate and much more',
      ],
    },
    smartB2B: {
      name: 'Smart B2B',
  ...
  webticketPage: {
    ...
    subtitle: 'Fill out the form below to open a support ticket.',
    successTitle: 'WebTicket Submitted Successfully!',
    successDesc: 'Your ticket has been registered. One of our technicians will contact you as soon as possible.',
    btnAnother: 'Submit another ticket',
    sectionRequester: 'Requester Details',
    labelNome: 'First Name',
    labelCognome: 'Last Name',
    labelRagioneSociale: 'Company Name',
    ...
    labelTelefonoFisso: 'Landline Phone',
    labelCellulare: 'Mobile Phone',
    sectionTicket: 'WebTicket Details',
    ...
    btnPreview: 'Email Preview',
    previewTitle: 'WebTicket Email Preview',
    previewSubject: 'Subject',
    previewFrom: 'From',
    previewTo: 'To',
    previewReplyTo: 'Reply To',
    previewAttachments: 'Attachments',
    previewNoAttachments: 'No attachments',
    previewNoDesc: 'No description provided.',
    previewClose: 'Close',
    erpOptions: {
      option1: 'ERP - Accounting',
      option2: 'ERP - Documents',
      option3: 'ERP - Warehouse',
      option4: 'ERP - Production',
      option5: 'ERP - Gestione GP',
      option6: 'ERP - Connector',
